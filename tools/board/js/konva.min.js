!(function (t, e) {
  ...
  var h = (function () {
      ...
      return (
        ...
        (t.prototype.decompose = function () {
          ...
          if (0 != t || 0 != e) {
            ...
            (o.rotation = e > 0 ? Math.acos(t / a) : -Math.acos(t / a)),
              (o.scaleX = a),
              (o.scaleY = r / a),
              (o.skewX = (t * i + e * n) / r),
              (o.skewY = 0);
            ...
            (o.rotation =
              Math.PI / 2 - (n > 0 ? Math.acos(-i / s) : -Math.acos(i / s))),
              (o.scaleX = r / s),
              (o.scaleY = s),
              (o.skewX = 0),
              (o.skewY = (t * i + e * n) / r);
    ...
    f = {
      ...
      colorToRGBA: function (t) {
        return (
          (t = t || "black"),
          f._namedColorToRBA(t) ||
            f._hex3ColorToRGBA(t) ||
            f._hex6ColorToRGBA(t) ||
            f._rgbColorToRGBA(t) ||
            f._rgbaColorToRGBA(t) ||
            f._hslColorToRGBA(t)
        );
      },
      ...
      _getProjectionToSegment: function (t, e, i, n, r, o) {
        ...
        if (0 == l)
          ...
          c < 0
            ? ((a = t), (s = e), (h = (t - r) * (t - r) + (e - o) * (e - o)))
            : c > 1
            ? ((a = i), (s = n), (h = (i - r) * (i - r) + (n - o) * (n - o)))
            : (h =
                ((a = t + c * (i - t)) - r) * (a - r) +
                ((s = e + c * (n - e)) - o) * (s - o));
        }
        ...
        for (var i in ((t.visitedByCircularReferenceRemoval = !0), t))
          if (t.hasOwnProperty(i) && t[i] && "object" == typeof t[i])
            if (
              ...
              t[i].visitedByCircularReferenceRemoval || f._isElement(t[i]))
            ) {
    ...
    A = (function () {
      function t(t) {
        (this.canvas = t),
          ...
          r.enableTrace && ((this.traceArr = []), this._enableTrace());
      }
      return (
        ...
        (t.prototype.drawImage = function (t, e, i, n, r, o, a, s, h) {
          ...
          3 === l.length
            ...
            : 9 === l.length && c.drawImage(t, e, i, n, r, o, a, s, h);
        }),
        ...
        (t.prototype._enableTrace = function () {
          var t,
            ...
            a = function (t) {
              ...
              i[t] = function () {
                return (
                  (e = r(Array.prototype.slice.call(arguments, 0))),
  ...
  var L = (function () {
    function t(t) {
      ...
      (this.pixelRatio = e),
        (this._canvas = f.createCanvasElement()),
  ...
  var E = (function (t) {
    ...
    D = {
      get isDragging() {
        var t = !1;
        return (
          D._dragElements.forEach(function (e) {
      ...
      _drag: function (t) {
        ...
        D._dragElements.forEach(function (i, n) {
          ...
          o.setPointersPositions(t),
            void 0 === i.pointerId && (i.pointerId = f._getFirstPointerId(t));
      ...
      _endDragAfter: function (t) {
        D._dragElements.forEach(function (e, i) {
          "stopped" === e.dragStatus &&
            ...
            "dragging" !== e.dragStatus && D._dragElements.delete(i);
        });
      },
    };
  r.isBrowser &&
    (window.addEventListener("mouseup", D._endDragBefore, !0),
    window.addEventListener("touchend", D._endDragBefore, !0),
    window.addEventListener("mousemove", D._drag),
    window.addEventListener("touchmove", D._drag),
    window.addEventListener("mouseup", D._endDragAfter, !1),
    window.addEventListener("touchend", D._endDragAfter, !1));
  var I = {},
    F = {},
    B = function (t, e) {
      t && I[t] === e && delete I[t];
    ...
    X = (function () {
      ...
      return (
        ...
        (t.prototype.cache = function (t) {
          ...
          if (n && r) {
            ...
            var c = new E({
              ...
              d = new E({ pixelRatio: o, width: 0, height: 0 }),
              u = new O({ pixelRatio: 1, width: n, height: r }),
              p = c.getContext(),
              g = u.getContext();
            return (
              (u.isCache = !0),
        ...
        (t.prototype._delegate = function (t, e, i) {
          ...
          this.on(t, function (t) {
            for (
              var r = t.target.findAncestors(e, !0, n), o = 0;
              o < r.length;
              o++
            )
        ...
        (t.prototype.remove = function () {
          return (
            ...
            D._dragElements.delete(this._id),
            this._remove(),
            this
          );
        }),
        ...
        (t.prototype.setAttrs = function (t) {
          ...
          return (
            this._batchTransformChanges(function () {
              ...
              for (i in t)
                "children" !== i &&
                  ((n = "set" + f._capitalize(i)),
                  f._isFunction(e[n]) ? e[n](t[i]) : e._setAttr(i, t[i]));
            }),
            this
          );
        }),
              ...
              (function s(h) {
                for (t = [], e = h.length, i = 0; i < e; i++)
                  (n = h[i]),
                    a++,
                    "Shape" !== n.nodeType &&
                      (t = t.concat(n.getChildren().toArray())),
                    n._id === o._id && (i = e);
        ...
        (t.prototype.moveToTop = function () {
          if (!this.parent)
            return (
              f.warn("Node has no parent. moveToTop function is ignored."), !1
            );
          var t = this.index;
          return (
        ...
        (t.prototype.moveUp = function () {
          if (!this.parent)
            return (
              f.warn("Node has no parent. moveUp function is ignored."), !1
            );
          var t = this.index;
          return (
        ...
        (t.prototype.moveDown = function () {
          if (!this.parent)
            return (
              f.warn("Node has no parent. moveDown function is ignored."), !1
            );
          var t = this.index;
          return (
            t > 0 &&
        ...
        (t.prototype.moveToBottom = function () {
          if (!this.parent)
            return (
              f.warn("Node has no parent. moveToBottom function is ignored."),
              !1
            );
          var t = this.index;
          return (
        ...
        (t.prototype.setZIndex = function (t) {
          if (!this.parent)
            return (
              f.warn("Node has no parent. zIndex parameter is ignored."), this
            );
        ...
        (t.prototype.toObject = function () {
          ...
          for (t in ((r.attrs = {}), o))
            (e = o[t]),
              (f.isObject(e) && !f._isPlainObject(e) && !f._isArray(e)) ||
        ...
        (t.prototype._getAbsoluteTransform = function (t) {
          ...
          (e = this._cache.get("absoluteTransform") || new h()),
            this.parent
        ...
        (t.prototype.toImage = function (t) {
          ...
          var e = t.callback;
          delete t.callback,
            f._urlToImage(this.toDataURL(t), function (t) {
              e(t);
            });
        }),
        ...
        (t.prototype._fire = function (t, e) {
          ...
          if (r) for (n = 0; n < r.length; n++) r[n].handler.call(this, e);
        }),
        ...
        (t.prototype.startDrag = function (t, e) {
          void 0 === e && (e = !0),
            D._dragElements.has(this._id) || this._createDragElement(t),
            (D._dragElements.get(this._id).dragStatus = "dragging"),
            this.fire(
              "dragstart",
        ...
        (t.prototype._listenDrag = function () {
          this._dragCleanup(),
            this.on("mousedown.konva touchstart.konva", function (t) {
              ...
              if (
                (!(void 0 !== t.evt.button) ||
                  r.dragButtons.indexOf(t.evt.button) >= 0) &&
                !this.isDragging()
              ) {
                var i = !1;
                D._dragElements.forEach(function (t) {
  ...
  (X.prototype.nodeType = "Node"),
    ...
    X.prototype.on.call(X.prototype, W, function () {
  ...
  j(X, "zIndex"),
    j(X, "absolutePosition"),
    j(X, "position"),
    j(X, "x", 0, y()),
    j(X, "y", 0, y()),
    j(X, "globalCompositeOperation", "source-over", b()),
    j(X, "opacity", 1, y()),
    j(X, "name", "", b()),
    j(X, "id", "", b()),
    j(X, "rotation", 0, y()),
    w.addComponentsGetterSetter(X, "scale", ["x", "y"]),
    j(X, "scaleX", 1, y()),
    j(X, "scaleY", 1, y()),
    w.addComponentsGetterSetter(X, "skew", ["x", "y"]),
    j(X, "skewX", 0, y()),
    j(X, "skewY", 0, y()),
    w.addComponentsGetterSetter(X, "offset", ["x", "y"]),
    j(X, "offsetX", 0, y()),
    j(X, "offsetY", 0, y()),
    j(X, "dragDistance", null, y()),
    j(X, "width", 0, y()),
    j(X, "height", 0, y()),
    j(X, "listening", !0, S()),
    j(X, "preventDefault", !0, S()),
    j(X, "filters", null, function (t) {
      return (this._filterUpToDate = !1), t;
    }),
    j(X, "visible", !0, S()),
    j(X, "transformsEnabled", "all", b()),
    j(X, "size"),
    j(X, "dragBoundFunc"),
    j(X, "draggable", !1, S()),
    w.backCompat(X, {
    ...
    return (
      ...
      (e.prototype.drawScene = function (t, e) {
        ...
        if (a) {
          ...
          r.transform(h[0], h[1], h[2], h[3], h[4], h[5]),
      ...
      (e.prototype._drawChildren = function (t, e, i) {
        ...
        if (s) {
          ...
          var l = this.getAbsoluteTransform(i),
            c = l.getMatrix();
          if (
            (n.transform(c[0], c[1], c[2], c[3], c[4], c[5]), n.beginPath(), a)
          )
            a.call(this, n, this);
          else {
            var d = this.clipX(),
          ...
          n.clip(),
            (c = l.copy().invert().getMatrix()),
            n.transform(c[0], c[1], c[2], c[3], c[4], c[5]);
        }
        var p =
          !h &&
  ...
  w.addComponentsGetterSetter(U, "clip", ["x", "y", "width", "height"]),
    w.addGetterSetter(U, "clipX", void 0, y()),
    w.addGetterSetter(U, "clipY", void 0, y()),
    w.addGetterSetter(U, "clipWidth", void 0, y()),
    w.addGetterSetter(U, "clipHeight", void 0, y()),
    w.addGetterSetter(U, "clipFunc"),
    s.mapMethods(U);
  var q = new Map(),
    ...
    $(t),
      e.getStage() &&
        ...
        K &&
          e._fire(
            "gotpointercapture",
            Q(new PointerEvent("gotpointercapture"))
          ));
  }
  function $(t, e) {
    var i = q.get(t);
    if (i) {
      ...
      n && n.content,
        ...
        K &&
          i._fire(
            "lostpointercapture",
            Q(new PointerEvent("lostpointercapture"))
          );
    }
  }
  var tt = [
    ...
    return (
      ...
      (e.prototype.add = function (e) {
        ...
        return (
          ...
          e.draw(),
          r.isBrowser && this.content.appendChild(e.canvas._canvas),
          this
        );
      }),
      ...
      (e.prototype._bindContentEvents = function () {
        if (r.isBrowser) for (var t = 0; t < et; t++) it(this, tt[t]);
      }),
      ...
      (e.prototype._mousemove = function (t) {
        ...
        if (a) {
          if (
            ...
            a && o !== i
              ? (o &&
                  (o._fireAndBubble("mouseout", { evt: t, pointerId: n }, i),
                  o._fireAndBubble("mouseleave", { evt: t, pointerId: n }, i)),
                i._fireAndBubble("mouseover", { evt: t, pointerId: n }, o),
                i._fireAndBubble("mouseenter", { evt: t, pointerId: n }, o),
                i._fireAndBubble("mousemove", { evt: t, pointerId: n }),
                (this.targetShape = i))
              : i._fireAndBubble("mousemove", { evt: t, pointerId: n });
          else
            o &&
              a &&
              (o._fireAndBubble("mouseout", { evt: t, pointerId: n }),
              o._fireAndBubble("mouseleave", { evt: t, pointerId: n }),
              this._fire("mouseover", {
                evt: t,
                target: this,
                currentTarget: this,
      ...
      (e.prototype._mouseup = function (t) {
        ...
        r.inDblClickWindow
          ...
          : D.justDragged ||
            ((r.inDblClickWindow = !0), clearTimeout(this.dblTimeout)),
      ...
      (e.prototype._touchstart = function (t) {
        ...
        this._changedPointerPositions.forEach(function (n) {
          ...
          (r.listenClickTap = !0),
            ...
            o &&
              o.isListening() &&
              (r.captureTouchEventsEnabled && o.setPointerCapture(n.id),
              (e.tapStartShape = o),
              o._fireAndBubble("touchstart", { evt: t, pointerId: n.id }, e),
              (i = !0),
              o.isListening() &&
                o.preventDefault() &&
                t.cancelable &&
      ...
      (e.prototype._touchmove = function (t) {
        var e = this;
        if (
          (this.setPointersPositions(t), !D.isDragging || r.hitOnDragEnabled)
        ) {
          var i = !1,
            n = {};
          this._changedPointerPositions.forEach(function (r) {
            ...
            o &&
              ...
              (n[o._id] ||
                ((n[o._id] = !0),
                o._fireAndBubble("touchmove", { evt: t, pointerId: r.id }),
                (i = !0),
                o.isListening() &&
                  o.preventDefault() &&
                  t.cancelable &&
      ...
      (e.prototype._touchend = function (t) {
        ...
        var i = this.tapEndShape,
          n = !1;
        r.inDblClickWindow
          ? ((n = !0), clearTimeout(this.dblTimeout))
          : D.justDragged ||
            ((r.inDblClickWindow = !0), clearTimeout(this.dblTimeout)),
          (this.dblTimeout = setTimeout(function () {
            r.inDblClickWindow = !1;
        ...
        this._changedPointerPositions.forEach(function (l) {
            ...
            c &&
              ...
              (a[c._id] ||
                ...
                r.listenClickTap &&
                  c === e.tapStartShape &&
                  ((s = !0),
                  c._fireAndBubble("tap", { evt: t, pointerId: l.id }),
                  n &&
                    i &&
                    i === c &&
                    ((h = !0),
                    c._fireAndBubble("dbltap", { evt: t, pointerId: l.id }))),
                c.isListening() &&
                  c.preventDefault() &&
                  t.cancelable &&
                  t.preventDefault()));
          ...
          r.listenClickTap &&
            ...
            n && this._fire("contentDbltap", { evt: t })),
      ...
      (e.prototype._pointerdown = function (t) {
        if (r._pointerEventsEnabled) {
          this.setPointersPositions(t);
          var e =
            V(t.pointerId) || this.getIntersection(this.getPointerPosition());
      ...
      (e.prototype.setPointersPositions = function (t) {
        ...
        void 0 !== (t = t || window.event).touches
          ? ((this._pointerPositions = []),
            ...
            s.prototype.each.call(t.touches, function (t) {
          ...
          : ((n = (t.clientX - i.left) / i.scaleX),
            ...
            (this._pointerPositions = [
              { x: n, y: r, id: f._getFirstPointerId(t) },
            ]),
            (this._changedPointerPositions = [
              { x: n, y: r, id: f._getFirstPointerId(t) },
            ]));
    ...
    return (
      ...
      (e.prototype.drawScene = function (t, e) {
        ...
        if ((a.save(), this._useBufferCanvas() && !d)) {
          (n = (i = this.getStage().bufferCanvas).getContext()).clear(),
            n.save(),
          ...
          l && a._applyShadow(this),
            ...
            a.drawImage(i._canvas, 0, 0, i.width / g, i.height / g);
        } else {
  ...
  (lt.prototype._fillFunc = function (t) {
    ...
    (lt.prototype._centroid = !1),
    (lt.prototype.nodeType = "Shape"),
    a(lt),
    (lt.prototype.eventListeners = {}),
    lt.prototype.on.call(
      lt.prototype,
    ...
    w.addGetterSetter(lt, "stroke", void 0, x()),
    w.addGetterSetter(lt, "strokeWidth", 2, y()),
    w.addGetterSetter(lt, "fillAfterStrokeEnabled", !1),
    w.addGetterSetter(lt, "hitStrokeWidth", "auto", _()),
    w.addGetterSetter(lt, "strokeHitEnabled", !0, S()),
    w.addGetterSetter(lt, "perfectDrawEnabled", !0, S()),
    w.addGetterSetter(lt, "shadowForStrokeEnabled", !0, S()),
    w.addGetterSetter(lt, "lineJoin"),
    w.addGetterSetter(lt, "lineCap"),
    w.addGetterSetter(lt, "sceneFunc"),
    w.addGetterSetter(lt, "hitFunc"),
    w.addGetterSetter(lt, "dash"),
    w.addGetterSetter(lt, "dashOffset", 0, y()),
    w.addGetterSetter(lt, "shadowColor", void 0, b()),
    w.addGetterSetter(lt, "shadowBlur", 0, y()),
    w.addGetterSetter(lt, "shadowOpacity", 1, y()),
    w.addComponentsGetterSetter(lt, "shadowOffset", ["x", "y"]),
    w.addGetterSetter(lt, "shadowOffsetX", 0, y()),
    w.addGetterSetter(lt, "shadowOffsetY", 0, y()),
    w.addGetterSetter(lt, "fillPatternImage"),
    w.addGetterSetter(lt, "fill", void 0, x()),
    w.addGetterSetter(lt, "fillPatternX", 0, y()),
    w.addGetterSetter(lt, "fillPatternY", 0, y()),
    w.addGetterSetter(lt, "fillLinearGradientColorStops"),
    w.addGetterSetter(lt, "strokeLinearGradientColorStops"),
    w.addGetterSetter(lt, "fillRadialGradientStartRadius", 0),
    w.addGetterSetter(lt, "fillRadialGradientEndRadius", 0),
    w.addGetterSetter(lt, "fillRadialGradientColorStops"),
    w.addGetterSetter(lt, "fillPatternRepeat", "repeat"),
    w.addGetterSetter(lt, "fillEnabled", !0),
    w.addGetterSetter(lt, "strokeEnabled", !0),
    w.addGetterSetter(lt, "shadowEnabled", !0),
    w.addGetterSetter(lt, "dashEnabled", !0),
    w.addGetterSetter(lt, "strokeScaleEnabled", !0),
    w.addGetterSetter(lt, "fillPriority", "color"),
    w.addComponentsGetterSetter(lt, "fillPatternOffset", ["x", "y"]),
    w.addGetterSetter(lt, "fillPatternOffsetX", 0, y()),
    w.addGetterSetter(lt, "fillPatternOffsetY", 0, y()),
    w.addComponentsGetterSetter(lt, "fillPatternScale", ["x", "y"]),
    w.addGetterSetter(lt, "fillPatternScaleX", 1, y()),
    w.addGetterSetter(lt, "fillPatternScaleY", 1, y()),
    w.addComponentsGetterSetter(lt, "fillLinearGradientStartPoint", ["x", "y"]),
    w.addComponentsGetterSetter(lt, "strokeLinearGradientStartPoint", [
      "x",
      "y",
    ]),
    w.addGetterSetter(lt, "fillLinearGradientStartPointX", 0),
    w.addGetterSetter(lt, "strokeLinearGradientStartPointX", 0),
    w.addGetterSetter(lt, "fillLinearGradientStartPointY", 0),
    w.addGetterSetter(lt, "strokeLinearGradientStartPointY", 0),
    w.addComponentsGetterSetter(lt, "fillLinearGradientEndPoint", ["x", "y"]),
    w.addComponentsGetterSetter(lt, "strokeLinearGradientEndPoint", ["x", "y"]),
    w.addGetterSetter(lt, "fillLinearGradientEndPointX", 0),
    w.addGetterSetter(lt, "strokeLinearGradientEndPointX", 0),
    w.addGetterSetter(lt, "fillLinearGradientEndPointY", 0),
    w.addGetterSetter(lt, "strokeLinearGradientEndPointY", 0),
    w.addComponentsGetterSetter(lt, "fillRadialGradientStartPoint", ["x", "y"]),
    w.addGetterSetter(lt, "fillRadialGradientStartPointX", 0),
    w.addGetterSetter(lt, "fillRadialGradientStartPointY", 0),
    w.addComponentsGetterSetter(lt, "fillRadialGradientEndPoint", ["x", "y"]),
    w.addGetterSetter(lt, "fillRadialGradientEndPointX", 0),
    w.addGetterSetter(lt, "fillRadialGradientEndPointY", 0),
    w.addGetterSetter(lt, "fillPatternRotation", 0),
    w.backCompat(lt, {
      dashArray: "dash",
  ...
  var ct = [
    ...
    ut = (function (t) {
      function e(e) {
        ...
        return (
          (i.canvas = new E()),
          (i.hitCanvas = new O({ pixelRatio: 1 })),
          (i._waitingForDraw = !1),
          i.on("visibleChange.konva", i._checkVisibility),
          i._checkVisibility(),
      ...
      return (
        ...
        (e.prototype._validateAdd = function (t) {
          ...
          "Group" !== e &&
            "Shape" !== e &&
            f.throw("You may only add groups and shapes to a layer.");
        }),
        (e.prototype._toKonvaCanvas = function (t) {
          return (
            ...
            X.prototype._toKonvaCanvas.call(this, t)
          );
        }),
        (e.prototype._checkVisibility = function () {
          var t = this.visible();
        ...
        (e.prototype.drawScene = function (t, e) {
          ...
          return (
            ...
            U.prototype.drawScene.call(this, n, e),
        ...
        (e.prototype.drawHit = function (t, e) {
          ...
          return (
            ...
            U.prototype.drawHit.call(this, n, e),
            this
          );
        }),
  ...
  (ut.prototype.nodeType = "Layer"),
    a(ut),
    w.addGetterSetter(ut, "imageSmoothingEnabled", !0),
    w.addGetterSetter(ut, "clearBeforeDraw", !0),
    w.addGetterSetter(ut, "hitGraphEnabled", !0, S()),
    s.mapMethods(ut);
  var pt = (function (t) {
    function e(e) {
      var i = t.call(this, e) || this;
  ...
  var ft = (function (t) {
    ...
    return (
      ...
      (e.prototype._validateAdd = function (t) {
        ...
        "Group" !== e &&
          "Shape" !== e &&
          f.throw("You may only add groups and shapes to groups.");
      }),
      e
    );
  })(U);
  ...
  var gt =
    ...
    vt = (function () {
      function t(e, i) {
        (this.id = t.animIdCounter++),
          (this.frame = { time: 0, timeDiff: 0, lastTime: gt(), frameRate: 0 }),
          (this.func = e),
          this.setLayers(i);
      }
      return (
    ...
    yt = { node: 1, duration: 1, easing: 1, onFinish: 1, yoyo: 1 },
    mt = 0,
    ...
    xt = (function () {
      function t(e) {
        var i,
          ...
          l = !!e.yoyo;
        (i =
          void 0 === e.duration ? 0.3 : 0 === e.duration ? 0.001 : e.duration),
          (this.node = a),
          (this._id = mt++);
        ...
        this._addListeners(),
        t.attrs[s] || (t.attrs[s] = {}),
        t.attrs[s][this._id] || (t.attrs[s][this._id] = {}),
        t.tweens[s] || (t.tweens[s] = {}),
        e))
      ...
      return (
        (t.prototype._addAttr = function (e, i) {
          var n,
            ...
            u = d._id;
          if (
            ((o = t.tweens[u][e]) && delete t.attrs[u][o][e],
            (n = d.getAttr(e)),
            f._isArray(i))
          )
            if (
              ...
              "points" === e &&
                i.length !== n.length &&
                (i.length > n.length
                  ? ((l = n), (n = f._prepareArrayForTween(n, i, d.closed())))
                  : ((h = i), (i = f._prepareArrayForTween(i, n, d.closed())))),
              0 === e.indexOf("fill"))
            )
              for (a = 0; a < s; a++)
            ...
            else for (a = 0; a < s; a++) r.push(i[a] - n[a]);
          else
            -1 !== _t.indexOf(e)
              ? ((n = f.colorToRGBA(n)),
                (r = {
        ...
        (t.prototype._tweenFunc = function (e) {
          ...
          for (i in d) {
            if (
              ((r = (n = d[i]).start), (o = n.diff), (l = n.end), f._isArray(r))
            )
              if (
                ((a = []),
                (h = Math.max(r.length, l.length)),
                0 === i.indexOf("fill"))
              )
                for (s = 0; s < h; s++)
                  s % 2 == 0
                    ...
                    : a.push(
                        "rgba(" +
                          Math.round(r[s].r + o[s].r * e) +
                          "," +
                          Math.round(r[s].g + o[s].g * e) +
                          "," +
                          Math.round(r[s].b + o[s].b * e) +
                          "," +
                          (r[s].a + o[s].a * e) +
                          ")"
                      );
              else for (s = 0; s < h; s++) a.push((r[s] || 0) + o[s] * e);
            else
              a =
                -1 !== _t.indexOf(i)
                  ? "rgba(" +
                    Math.round(r.r + o.r * e) +
                    "," +
                    Math.round(r.g + o.g * e) +
                    "," +
                    Math.round(r.b + o.b * e) +
                    "," +
                    (r.a + o.a * e) +
                    ")"
                  : r + o * e;
        ...
        (t.prototype._addListeners = function () {
          ...
          (this.tween.onPlay = function () {
            ...
            (this.tween.onFinish = function () {
              ...
              n.points &&
                n.points.trueEnd &&
                i.setAttr("points", n.points.trueEnd),
  ...
  var St = {
      ...
      BounceEaseInOut: function (t, e, i, n) {
        return t < n / 2
          ? 0.5 * St.BounceEaseIn(2 * t, 0, i, n) + e
          : 0.5 * St.BounceEaseOut(2 * t - n, 0, i, n) + 0.5 * i + e;
      },
  ...
  (Ct.prototype._centroid = !0),
    (Ct.prototype.className = "Arc"),
    (Ct.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"]),
    a(Ct),
    w.addGetterSetter(Ct, "innerRadius", 0, y()),
    w.addGetterSetter(Ct, "outerRadius", 0, y()),
    w.addGetterSetter(Ct, "angle", 0, y()),
    w.addGetterSetter(Ct, "clockwise", !1, S()),
    s.mapMethods(Ct);
  var Pt = (function (t) {
    function e(e) {
      var i = t.call(this, e) || this;
    ...
    return (
      ...
      (e.prototype._getTensionPoints = function () {
        return this.closed()
          ...
          : f._expandPoints(this.points(), this.tension());
      }),
  ...
  (Pt.prototype.className = "Line"),
    (Pt.prototype._attrsAffectingSize = ["points", "bezier", "tension"]),
    a(Pt),
    w.addGetterSetter(Pt, "closed", !1),
    w.addGetterSetter(Pt, "bezier", !1),
    w.addGetterSetter(Pt, "tension", 0, y()),
    w.addGetterSetter(
      Pt,
      "points",
      [],
    ...
    return (
      ...
      (e.prototype._sceneFunc = function (e) {
        ...
        var a,
          ...
          h = n.length;
        o
          ? ((a = n[h - 2] - (r[r.length - 2] + r[r.length - 4]) / 2),
            (s = n[h - 1] - (r[r.length - 1] + r[r.length - 3]) / 2))
          : ((a = n[h - 2] - n[h - 4]), (s = n[h - 1] - n[h - 3]));
        ...
        e.save(),
          ...
          this.pointerAtBeginning() &&
            ...
            e.translate(n[0], n[1]),
            o
              ? ((a = (r[0] + r[2]) / 2 - n[0]), (s = (r[1] + r[3]) / 2 - n[1]))
              : ((a = n[2] - n[0]), (s = n[3] - n[1])),
        ...
        u && ((this.attrs.dashEnabled = !1), e.setLineDash([])),
  ...
  (kt.prototype.className = "Arrow"),
    a(kt),
    w.addGetterSetter(kt, "pointerLength", 10, y()),
    w.addGetterSetter(kt, "pointerWidth", 10, y()),
    w.addGetterSetter(kt, "pointerAtBeginning", !1),
    s.mapMethods(kt);
  var Tt = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
  ...
  (Tt.prototype._centroid = !0),
    (Tt.prototype.className = "Circle"),
    (Tt.prototype._attrsAffectingSize = ["radius"]),
    a(Tt),
    w.addGetterSetter(Tt, "radius", 0, y()),
    s.mapMethods(Tt);
  var At = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
  ...
  (At.prototype.className = "Ellipse"),
    (At.prototype._centroid = !0),
    (At.prototype._attrsAffectingSize = ["radiusX", "radiusY"]),
    a(At),
    w.addComponentsGetterSetter(At, "radius", ["x", "y"]),
    w.addGetterSetter(At, "radiusX", 0, y()),
    ...
    return (
      ...
      (e.prototype._sceneFunc = function (t) {
        ...
        if (r) {
          ...
          e =
            o && a
              ? [r, this.cropX(), this.cropY(), o, a, 0, 0, i, n]
              : [r, 0, 0, i, n];
        }
      ...
      (e.prototype.getWidth = function () {
        ...
        return null !== (t = this.attrs.width) && void 0 !== t
          ? t
          : (null === (e = this.image()) || void 0 === e ? void 0 : e.width) ||
              0;
      }),
      (e.prototype.getHeight = function () {
        var t, e;
        return null !== (t = this.attrs.height) && void 0 !== t
          ? t
          : (null === (e = this.image()) || void 0 === e ? void 0 : e.height) ||
              0;
      }),
  ...
  (Mt.prototype.className = "Image"),
    a(Mt),
    w.addGetterSetter(Mt, "image"),
    w.addComponentsGetterSetter(Mt, "crop", ["x", "y", "width", "height"]),
    w.addGetterSetter(Mt, "cropX", 0, y()),
  ...
  (Et.prototype.className = "Tag"),
    a(Et),
    w.addGetterSetter(Et, "pointerDirection", "none"),
    w.addGetterSetter(Et, "pointerWidth", 0, y()),
    w.addGetterSetter(Et, "pointerHeight", 0, y()),
    w.addGetterSetter(Et, "cornerRadius", 0, m(4)),
    s.mapMethods(Et);
  var Ot = (function (t) {
    function e(i) {
    ...
    return (
      ...
      (e.prototype.getSelfRect = function () {
          ...
          if ("A" === i.command) {
            ...
            if ((Math.abs(n - o) < a && (a = Math.abs(n - o)), r < 0))
              for (var s = n - a; s > o; s -= a) {
                var h = e.getPointOnEllipticalArc(
                  i.points[0],
                  i.points[1],
                  i.points[2],
                  i.points[3],
        ...
        for (
          var i, n, r = t[0], o = t[0], a = t[1], s = t[1], h = 0;
          h < t.length / 2;
          h++
        )
          (i = t[2 * h]),
            ...
            isNaN(n) || ((a = Math.min(a, n)), (s = Math.max(s, n)));
        return {
          x: Math.round(r),
          y: Math.round(a),
      ...
      (e.prototype.getPointAtLength = function (t) {
        ...
        if (t < 0.01)
          return { x: (i = this.dataArray[n].points.slice(0, 2))[0], y: i[1] };
        ...
        switch (o.command) {
          ...
          case "A":
            ...
            return (
              (d += (u * t) / o.pathLength),
              e.getPointOnEllipticalArc(s, h, l, c, d, p)
            );
        }
        return null;
      }),
            ...
            switch (u) {
              ...
              case "s":
                (m = h),
                  ...
                  "C" === (y = a[a.length - 1]).command &&
                    ((m = h + (h - y.points[2])), (_ = l + (l - y.points[3]))),
                  A.push(m, _, h + p.shift(), l + p.shift()),
                  (h += p.shift()),
                  (l += p.shift()),
                  (T = "C"),
                  A.push(h, l);
        ...
        switch (n) {
          ...
          case "C":
            for (
              ...
              (s = l.getPointOnCubicBezier(
                ...
                (o += l.getLineLength(a.x, a.y, s.x, s.y)),
                (a = s);
            return o;
          case "Q":
            for (
              o = 0,
                a = l.getPointOnQuadraticBezier(
                  0,
                  t,
                  i,
                  r[0],
          ...
          case "A":
            ...
            var c = r[4],
              ...
              p = Math.PI / 180;
            if (
              (Math.abs(c - u) < p && (p = Math.abs(c - u)),
              (a = l.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], c, 0)),
              d < 0)
            )
              for (h = c - p; h > u; h -= p)
                (s = l.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], h, 0)),
                  (o += l.getLineLength(a.x, a.y, s.x, s.y)),
                  (a = s);
            else
              for (h = c + p; h < u; h += p)
                (s = l.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], h, 0)),
                  ...
                  (a = s);
            return (
              (s = l.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], u, 0)),
              (o += l.getLineLength(a.x, a.y, s.x, s.y))
            );
        }
        return 0;
      ...
      (e.prototype._sceneFunc = function (t) {
        ...
        if ((t.beginPath(), e)) {
          ...
          "number" == typeof e
            ...
            : ((r = Math.min(e[0] || 0, i / 2, n / 2)),
              (o = Math.min(e[1] || 0, i / 2, n / 2)),
              (s = Math.min(e[2] || 0, i / 2, n / 2)),
              (a = Math.min(e[3] || 0, i / 2, n / 2))),
            t.moveTo(r, 0),
            t.lineTo(i - o, 0),
  ...
  (Dt.prototype.className = "Rect"),
    a(Dt),
    w.addGetterSetter(Dt, "cornerRadius", 0, m(4)),
    s.mapMethods(Dt);
  var It = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
    ...
    return (
      ...
      (e.prototype._getPoints = function () {
        for (
          var t = this.attrs.sides, e = this.attrs.radius || 0, i = [], n = 0;
          n < t;
          n++
        )
          i.push({
  ...
  (It.prototype.className = "RegularPolygon"),
    ...
    a(It),
    w.addGetterSetter(It, "radius", 0, y()),
  ...
  var Ft = 2 * Math.PI,
    Bt = (function (t) {
      ...
      return (
        ...
        (e.prototype._sceneFunc = function (t) {
          t.beginPath(),
            t.arc(0, 0, this.innerRadius(), 0, Ft, !1),
            t.moveTo(this.outerRadius(), 0),
            t.arc(0, 0, this.outerRadius(), Ft, 0, !0),
            t.closePath(),
            t.fillStrokeShape(this);
        }),
        (e.prototype.getWidth = function () {
  ...
  (Nt.prototype.className = "Sprite"),
    a(Nt),
    w.addGetterSetter(Nt, "animation"),
    w.addGetterSetter(Nt, "animations"),
    w.addGetterSetter(Nt, "frameOffsets"),
    w.addGetterSetter(Nt, "image"),
    w.addGetterSetter(Nt, "frameIndex", 0, y()),
    w.addGetterSetter(Nt, "frameRate", 17, y()),
    w.backCompat(Nt, {
      index: "frameIndex",
  ...
  (zt.prototype.className = "Star"),
    ...
    a(zt),
    w.addGetterSetter(zt, "numPoints", 5, y()),
    w.addGetterSetter(zt, "innerRadius", 0, y()),
        ...
        if (this.text()) {
          ...
          for (
            t.setAttr("font", this._getContextFont()),
              ...
              "middle" === s
                ? (h = (this.getHeight() - i * a - 2 * r) / 2)
                : "bottom" === s && (h = this.getHeight() - i * a - 2 * r),
              t.translate(r, h + r),
              n = 0;
            n < i;
            n++
            ...
            if (
              ...
              "right" === l
                ? (y += c - C - 2 * r)
                : "center" === l && (y += (c - C - 2 * r) / 2),
              f &&
                (t.save(),
                t.beginPath(),
                t.moveTo(y, v + m + Math.round(o / 2)),
                (b = 0 === (_ = w.split(" ").length - 1)),
                (x = "justify" === l && P && !b ? c - 2 * r : C),
                t.lineTo(y + Math.round(x), v + m + Math.round(o / 2)),
                (t.lineWidth = o / 15),
                (t.strokeStyle = u),
                t.stroke(),
                t.restore()),
            ...
            for (; _.length > 0; ) {
              ...
              if (f) {
                ...
                (A =
                  ...
                  0 &&
                  ((x = A), (w = w.slice(0, x)), (C = this._getTextWidth(w)));
              }
              if (
                ((w = w.trimRight()),
                this._addTextLine(w),
  ...
  (Ut.prototype._fillFunc = function (t) {
    ...
    a(Ut),
    w.overWriteSetter(Ut, "width", _()),
    w.overWriteSetter(Ut, "height", _()),
    w.addGetterSetter(Ut, "fontFamily", "Arial"),
    w.addGetterSetter(Ut, "fontSize", 12, y()),
    w.addGetterSetter(Ut, "fontStyle", "normal"),
    w.addGetterSetter(Ut, "fontVariant", "normal"),
    w.addGetterSetter(Ut, "padding", 0, y()),
    w.addGetterSetter(Ut, "align", "left"),
    w.addGetterSetter(Ut, "verticalAlign", "top"),
    w.addGetterSetter(Ut, "lineHeight", 1, y()),
    w.addGetterSetter(Ut, "wrap", "word"),
    w.addGetterSetter(Ut, "ellipsis", !1, S()),
    w.addGetterSetter(Ut, "letterSpacing", 0, y()),
    w.addGetterSetter(Ut, "text", "", b()),
    w.addGetterSetter(Ut, "textDecoration", ""),
    s.mapMethods(Ut);
  function qt(t) {
  ...
  var Vt = (function (t) {
    function e(e) {
      var i = t.call(this, e) || this;
      return (
        (i.dummyCanvas = f.createCanvasElement()),
        (i.dataArray = []),
        (i.dataArray = Ot.parsePathData(i.attrs.data)),
        i.on("dataChange.konva", function () {
          (this.dataArray = Ot.parsePathData(this.attrs.data)),
            this._setTextData();
        }),
        i.on(
        ...
        for (
          var l,
            ...
            y = function (e) {
              ...
              var s = 0,
                h = 0;
              for (c = void 0; Math.abs(r - s) / r > 0.01 && h < 20; ) {
                h++;
                for (var u = s; void 0 === d; )
                  (d = v()) &&
                    u + d.pathLength < r &&
                    ((u += d.pathLength), (d = void 0));
                if (d === {} || void 0 === l) return;
                var f = !1;
                switch (d.command) {
                  case "L":
                    Ot.getLineLength(l.x, l.y, d.points[0], d.points[1]) > r
                      ? (c = Ot.getPointOnLine(
                          r,
                          l.x,
                          l.y,
                  ...
                  case "A":
                    ...
                    0 === g
                      ? (g = y + 1e-8)
                      : r > s
                      ? (g += ((Math.PI / 180) * m) / Math.abs(m))
                      : (g -= ((Math.PI / 360) * m) / Math.abs(m)),
                      ((m < 0 && g < _) || (m >= 0 && g > _)) &&
                        ((g = _), (f = !0)),
                      (c = Ot.getPointOnEllipticalArc(
                        d.points[0],
                        d.points[1],
                        d.points[2],
                        d.points[3],
                  ...
                  case "C":
                    0 === g
                      ? (g = r > d.pathLength ? 1e-8 : r / d.pathLength)
                      : r > s
                      ? (g += (r - s) / d.pathLength / 2)
                      : (g = Math.max(g - (s - r) / d.pathLength / 2, 0)),
                      g > 1 && ((g = 1), (f = !0)),
                      (c = Ot.getPointOnCubicBezier(
                        g,
                        d.start.x,
                        d.start.y,
                        d.points[0],
                  ...
                  case "Q":
                    0 === g
                      ...
                      : (g -= (s - r) / d.pathLength),
                      g > 1 && ((g = 1), (f = !0)),
                      (c = Ot.getPointOnQuadraticBezier(
                        g,
                        d.start.x,
                        d.start.y,
                        d.points[0],
                ...
                void 0 !== c && (s = Ot.getLineLength(l.x, l.y, c.x, c.y)),
                  f && ((f = !1), (d = void 0));
              }
            },
            m = h / (t._getTextSize("C").width + i) - 1,
            _ = 0;
          _ < m && (y("C"), void 0 !== l && void 0 !== c);
          _++
        )
          l = c;
        for (
          var b = 0;
          b < u.length && (y(u[b]), void 0 !== l && void 0 !== c);
          b++
        ) {
  ...
  (Vt.prototype._fillFunc = qt),
    (Vt.prototype._strokeFunc = Kt),
    (Vt.prototype._fillFuncHit = qt),
    (Vt.prototype._strokeFuncHit = Kt),
    (Vt.prototype.className = "TextPath"),
    (Vt.prototype._attrsAffectingSize = ["text", "fontSize", "data"]),
    a(Vt),
    w.addGetterSetter(Vt, "data"),
    w.addGetterSetter(Vt, "fontFamily", "Arial"),
    w.addGetterSetter(Vt, "fontSize", 12, y()),
    w.addGetterSetter(Vt, "fontStyle", "normal"),
    w.addGetterSetter(Vt, "align", "left"),
    w.addGetterSetter(Vt, "letterSpacing", 0, y()),
    w.addGetterSetter(Vt, "textBaseline", "middle"),
    w.addGetterSetter(Vt, "fontVariant", "normal"),
    w.addGetterSetter(Vt, "text", ""),
    w.addGetterSetter(Vt, "textDecoration", null),
    w.addGetterSetter(Vt, "kerningFunc", null),
    s.mapMethods(Vt);
  var Qt = [
      "resizeEnabledChange",
    ...
    return (
      ...
      (e.prototype.setNodes = function (t) {
        ...
        return (
          ...
          (this._nodes = t),
          1 === t.length ? this.rotation(t[0].rotation()) : this.rotation(0),
          this._nodes.forEach(function (t) {
            var i = t._attrsAffectingSize
                ...
                .join(" "),
              n = function () {
                1 === e.nodes().length && e.rotation(e.nodes()[0].rotation()),
                  e._resetTransformCache(),
                  e._transforming || e.isDragging() || e.update();
              };
            t.on(i, n),
              t.on(Jt, n),
              t.on("_clearTransformCache.tr-konva", n),
              t.on("xChange.tr-konva yChange.tr-konva", n),
              e._proxyDrag(t);
          }),
      ...
      (e.prototype._proxyDrag = function (t) {
        ...
        t.on("dragstart.tr-konva", function (n) {
          (e = t.getAbsolutePosition()),
            i.isDragging() || t === i.findOne(".back") || i.startDrag(n, !1);
        }),
            ...
            if (e) {
              ...
              i.nodes().forEach(function (e) {
                if (e !== t && !e.isDragging()) {
                  ...
                  e.setAbsolutePosition({ x: i.x + o, y: i.y + a }),
                    e.startDrag(n);
                }
              }),
                (e = null);
      ...
      (e.prototype.__getNodeShape = function (t, e, i) {
        ...
        var n = t.getClientRect({
          ...
          l =
            (r.getAngle(t.getAbsoluteRotation()) + 2 * Math.PI) % (2 * Math.PI);
        return ee(
          {
      ...
      (e.prototype.__getNodeRect = function () {
        ...
        var i,
          ...
          a,
          s = new h();
        s.rotate(-r.getAngle(this.rotation())),
          e.forEach(function (t) {
            var e = s.point(t);
            void 0 === i && ((i = o = e.x), (n = a = e.y)),
              (i = Math.min(i, e.x)),
              (n = Math.min(n, e.y)),
              (o = Math.max(o, e.x)),
              (a = Math.max(a, e.y));
          ...
          i.on("mouseenter", function () {
            var n = r.getAngle(e.rotation()),
              o = (function (t, e) {
                ...
                return f._inRange(i, 337.5, 360) || f._inRange(i, 0, 22.5)
                  ? "ns-resize"
                  : f._inRange(i, 22.5, 67.5)
                  ? "nesw-resize"
                  : f._inRange(i, 67.5, 112.5)
                  ? "ew-resize"
                  : f._inRange(i, 112.5, 157.5)
                  ? "nwse-resize"
                  : f._inRange(i, 157.5, 202.5)
                  ? "ns-resize"
                  : f._inRange(i, 202.5, 247.5)
                  ? "nesw-resize"
                  : f._inRange(i, 247.5, 292.5)
                  ? "ew-resize"
                  : f._inRange(i, 292.5, 337.5)
                  ? "nwse-resize"
                  : (f.error(
          ...
          e = new lt({
            ...
            sceneFunc: function (t) {
              ...
              t.beginPath(),
                ...
                e.rotateEnabled() &&
                  t.lineTo(
                    this.width() / 2,
                    -e.rotateAnchorOffset() * f._sign(this.height()) - i
                  ),
                t.fillStrokeShape(this);
            },
            hitFunc: function (e, i) {
              if (t.shouldOverdrawWholeArea()) {
                var n = t.padding();
                e.beginPath(),
                  e.rect(-n, -n, i.width() + 2 * n, i.height() + 2 * n),
                  e.fillStrokeShape(i);
              }
            },
          });
          ...
          if ("rotater" !== this._movingAnchorName) {
            ...
            if ("top-left" === this._movingAnchorName) {
              ...
              if (d) {
                ...
                n = Math.sqrt(
                  Math.pow(o.x() - p.x, 2) + Math.pow(p.y - o.y(), 2)
                );
                (f = this.findOne(".top-right").x() < p.x ? -1 : 1),
                  (g = this.findOne(".top-right").y() > p.y ? -1 : 1);
                (e = n * this.cos * f),
                  (i = n * this.sin * g),
                  this.findOne(".top-right").x(p.x + e),
                  this.findOne(".top-right").y(p.y - i);
              }
              var v = o.position();
              ...
              if (d) {
                ...
                n = Math.sqrt(
                  Math.pow(p.x - o.x(), 2) + Math.pow(o.y() - p.y, 2)
                );
              ...
              if (d) {
                ...
                n = Math.sqrt(
                  Math.pow(o.x() - p.x, 2) + Math.pow(o.y() - p.y, 2)
                );
                (f = this.findOne(".bottom-right").x() < p.x ? -1 : 1),
                  (g = this.findOne(".bottom-right").y() < p.y ? -1 : 1);
                (e = n * this.cos * f),
                  (i = n * this.sin * g),
                  this.findOne(".bottom-right").x(p.x + e),
                  this.findOne(".bottom-right").y(p.y + i);
              }
            } else
              console.error(
                new Error(
      ...
      (e.prototype._fitNodesInto = function (t, e) {
        ...
        if (f._inRange(t.width, 2 * -this.padding() - 1, 1)) this.update();
        else if (f._inRange(t.height, 2 * -this.padding() - 1, 1))
          this.update();
        else {
          var o = new h();
          if (
            (o.rotate(r.getAngle(this.rotation())),
            this._movingAnchorName &&
              t.width < 0 &&
              this._movingAnchorName.indexOf("left") >= 0)
          ) {
            var a = o.point({ x: 2 * -this.padding(), y: 0 });
            (t.x += a.x),
              (t.y += a.y),
              ...
              (this._anchorDragOffset.x -= a.x),
              (this._anchorDragOffset.y -= a.y);
          } else if (
            this._movingAnchorName &&
            t.width < 0 &&
            this._movingAnchorName.indexOf("right") >= 0
          ) {
            a = o.point({ x: 2 * this.padding(), y: 0 });
            (this._movingAnchorName = this._movingAnchorName.replace(
              "right",
              "left"
            )),
          ...
          if (
            ...
            a = o.point({ x: 0, y: 2 * -this.padding() });
            (t.x += a.x),
              (t.y += a.y),
              (this._movingAnchorName = this._movingAnchorName.replace(
                "top",
          ...
          l.translate(n.x, n.y),
            l.rotate(n.rotation),
            l.scale(n.width / 1e7, n.height / 1e7);
          var c = new h();
          c.translate(t.x, t.y),
            c.rotate(t.rotation),
            c.scale(t.width / 1e7, t.height / 1e7);
          ...
          this._nodes.forEach(function (t) {
            ...
            this.rotation(f._getRotation(t.rotation)),
            this._resetTransformCache(),
            this.update(),
            this.getLayer().batchDraw();
        }
  ...
  (ne.prototype.className = "Transformer"),
    a(ne),
    w.addGetterSetter(ne, "enabledAnchors", te, function (t) {
      return (
        t instanceof Array || f.warn("enabledAnchors value should be an array"),
        t instanceof Array &&
          t.forEach(function (t) {
            -1 === te.indexOf(t) &&
              f.warn(
    ...
    w.addGetterSetter(ne, "resizeEnabled", !0),
    w.addGetterSetter(ne, "anchorSize", 10, y()),
    w.addGetterSetter(ne, "rotateEnabled", !0),
    w.addGetterSetter(ne, "rotationSnaps", []),
    w.addGetterSetter(ne, "rotateAnchorOffset", 50, y()),
    w.addGetterSetter(ne, "rotationSnapTolerance", 5, y()),
    w.addGetterSetter(ne, "borderEnabled", !0),
    w.addGetterSetter(ne, "anchorStroke", "rgb(0, 161, 255)"),
    w.addGetterSetter(ne, "anchorStrokeWidth", 1, y()),
    w.addGetterSetter(ne, "anchorFill", "white"),
    w.addGetterSetter(ne, "anchorCornerRadius", 0, y()),
    w.addGetterSetter(ne, "borderStroke", "rgb(0, 161, 255)"),
    w.addGetterSetter(ne, "borderStrokeWidth", 1, y()),
    w.addGetterSetter(ne, "borderDash"),
    w.addGetterSetter(ne, "keepRatio", !0),
    w.addGetterSetter(ne, "centeredScaling", !1),
    w.addGetterSetter(ne, "ignoreStroke", !1),
    w.addGetterSetter(ne, "padding", 0, y()),
    w.addGetterSetter(ne, "node"),
    w.addGetterSetter(ne, "nodes"),
    w.addGetterSetter(ne, "boundBoxFunc"),
    w.addGetterSetter(ne, "shouldOverdrawWholeArea", !1),
    w.backCompat(ne, {
  ...
  w.addGetterSetter(X, "embossStrength", 0.5, y(), w.afterSetFilter),
    w.addGetterSetter(X, "embossWhiteLevel", 0.5, y(), w.afterSetFilter),
    w.addGetterSetter(X, "embossDirection", "top-left", null, w.afterSetFilter),
    w.addGetterSetter(X, "embossBlend", !1, null, w.afterSetFilter);
  w.addGetterSetter(X, "enhance", 0, y(), w.afterSetFilter);
  w.addGetterSetter(X, "hue", 0, y(), w.afterSetFilter),
    w.addGetterSetter(X, "saturation", 0, y(), w.afterSetFilter),
    w.addGetterSetter(X, "luminance", 0, y(), w.afterSetFilter);
  w.addGetterSetter(X, "hue", 0, y(), w.afterSetFilter),
    w.addGetterSetter(X, "saturation", 0, y(), w.afterSetFilter),
    w.addGetterSetter(X, "value", 0, y(), w.afterSetFilter);
  function le(t, e, i) {
    var n = 4 * (i * t.width + e),
      r = [];
  ...
  w.addGetterSetter(X, "kaleidoscopePower", 2, y(), w.afterSetFilter),
    w.addGetterSetter(X, "kaleidoscopeAngle", 0, y(), w.afterSetFilter);
  w.addGetterSetter(X, "threshold", 0, y(), w.afterSetFilter);
  w.addGetterSetter(X, "noise", 0.2, y(), w.afterSetFilter);
  w.addGetterSetter(X, "pixelSize", 8, y(), w.afterSetFilter);
  w.addGetterSetter(X, "levels", 0.5, y(), w.afterSetFilter);
  ...
  w.addGetterSetter(X, "red", 0, function (t) {
    ...
    w.addGetterSetter(X, "blue", 0, v, w.afterSetFilter),
    w.addGetterSetter(X, "alpha", 1, function (t) {
      return (this._filterUpToDate = !1), t > 1 ? 1 : t < 0 ? 0 : t;
    });
  return (
    w.addGetterSetter(X, "threshold", 0.5, y(), w.afterSetFilter),
    wt.Util._assign(wt, {
      Arc: Ct,
      Arrow: kt,
      Circle: Tt,
      ...
      Filters: {
            ...
            do {
              ...
              if (
                ...
                var P = s[y] + w,
                  k = s[y + 1] + w,
                  T = s[y + 2] + w;
                (s[y] = P > 255 ? 255 : P < 0 ? 0 : P),
                  (s[y + 1] = k > 255 ? 255 : k < 0 ? 0 : k),
                  (s[y + 2] = T > 255 ? 255 : T < 0 ? 0 : T);
              } else {
                var A = i - w;
                A < 0 ? (A = 0) : A > 255 && (A = 255),
                  (s[y] = s[y + 1] = s[y + 2] = A);
          ...
          if (0 !== p) {
            for (r = 0; r < a; r += 4)
              (e = o[r + 0]) < s ? (s = e) : e > h && (h = e),
                (i = o[r + 1]) < l ? (l = i) : i > c && (c = i),
                (n = o[r + 2]) < d ? (d = n) : n > u && (u = n);
            ...
            for (
              ...
              (o[r + 0] = he(o[r + 0], s, h, v, g)),
                (o[r + 1] = he(o[r + 1], l, c, _, m)),
                (o[r + 2] = he(o[r + 2], d, u, S, x));
          }
        },
        ...
        HSV: function (t) {
          var e,
            ...
            p = 0.299 * h + 0.701 * d + 0.167 * u,
            f = 0.587 * h - 0.587 * d + 0.33 * u,
            g = 0.114 * h - 0.114 * d - 0.497 * u,
            v = 0.299 * h - 0.299 * d - 0.328 * u,
            y = 0.587 * h + 0.413 * d + 0.035 * u,
            m = 0.114 * h - 0.114 * d + 0.293 * u,
            _ = 0.299 * h - 0.3 * d + 1.25 * u,
            b = 0.587 * h - 0.586 * d - 1.05 * u,
            x = 0.114 * h + 0.886 * d - 0.2 * u;
          for (e = 0; e < s; e += 4)
            (i = a[e + 0]),
              (n = a[e + 1]),
              (r = a[e + 2]),
        ...
        Kaleidoscope: function (t) {
          ...
          if (!(u < 1)) {
            ...
            !(function (t, e, i) {
              ...
              for (_ = 0; _ < w; _ += 1)
                for (
                  b = Math.sin(_ * C), x = Math.cos(_ * C), m = 0;
                  m < S;
                  m += 1
                )
                  (r = Math.floor(d + ((y * m) / S) * x)),
                    (p =
                      s[
                        (n =
                          4 *
                          ((o = Math.floor(u + ((y * m) / S) * b)) * l + r)) + 0
                      ]),
                    (f = s[n + 1]),
                    (g = s[n + 2]),
                    (v = s[n + 3]),
                    ...
                    (h[n + 2] = g),
                    (h[n + 3] = v);
            })(t, y, { polarCenterX: c / 2, polarCenterY: d / 2 });
            ...
            var _ = (m = Math.ceil(m)),
              ...
              S = 1;
            for (
              g + m > c && ((b = _), (x = 0), (S = -1)), i = 0;
              i < d;
              i += 1
            )
              for (e = b; e !== x; e += S)
                (h = 4 * (c * i + (Math.round(e + g) % c))),
                  (r = y.data[h + 0]),
                  (o = y.data[h + 1]),
                  (a = y.data[h + 2]),
                  (s = y.data[h + 3]),
