...
$(document).ready(function () {
  if (window.location !== window.parent.location) {
    ...
    $("#board_wrap").css({
      transform:
        "scale(" + board_scale().scaleX + ", " + board_scale().scaleY + ")",
    });
  ...
  if (iframe_data) {
    ...
    board_playlist_title = parent.document.getElementById(
      "ibsd_playlist_title"
    ).value;
  ...
  mouseTarget.addEventListener("mouseleave", function (e) {
    if (drawing_canvas) drawing_canvas.stop_drawline();
  });
});

$(window).on("beforeunload", function () {
  if (drawing_canvas) drawing_canvas.destroy();
...
$(document).on("click", ".icon-drawing", function () {
  ...
  if (drawing_canvas.drawingLayer.attrs.visible == false) {
    ...
    drawing_canvas.drawingLayer.attrs.visible == true ||
    drawing_canvas.drawingLayer.attrs.visible == undefined
  ) {
...
$(document).on("click", ".icon-drawing2", function () {
  ...
  if (drawing_canvas.textLayer.attrs.visible == false) {
    ...
    drawing_canvas.textLayer.attrs.visible == true ||
    drawing_canvas.textLayer.attrs.visible == undefined
  ) {
    $(".icon-drawing6").removeClass("active");
...
$(document).on("click", ".icon-drawing3", function () {
  ...
  if (drawing_canvas.imageLayer.attrs.visible == false) {
    ...
    drawing_canvas.imageLayer.attrs.visible == true ||
    drawing_canvas.imageLayer.attrs.visible == undefined
  ) {
    $(".icon-drawing6").removeClass("active");
...
$(document).on("click", ".arrow_palette", function () {
  ...
  $('.arrow_color_wrap button[data-arrowcolor="' + arrow_color + '"]').addClass(
    "active"
  );
...
$(document).on("click", ".line_palette", function () {
  ...
  $('.line_color_wrap button[data-linecolor="' + line_color + '"]').addClass(
    "active"
  );
...
$(document).on("click", ".hlighter_palette", function () {
  ...
  $("#image_select")
    .children(".hlighter_wrap")
    .children(".select_hlighter_color_wrap")
    .children("button")
    .removeClass("active");
  $(
    '#image_select button[data-hlightercolor="' + hlighter_color + '"]'
  ).addClass("active");
...
$(document).on("click", ".drawing_stroke_width", function () {
  ...
  $(".stroke_width_wrap")
    .children(".drawing_stroke_width")
    .children("i")
    .removeClass("active");
  $(
    '.stroke_width_wrap button[data-strokewidth="' + stroke_width + '"] i'
  ).addClass("active");
  $(".stroke_width").click();
...
$(document).on("click", ".font_palette", function () {
  ...
  $('.font_color_wrap button[data-fontcolor="' + font_color + '"]').addClass(
    "active"
  );
