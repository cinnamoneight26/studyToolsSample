...
function btn_1_on_click() {
  ...
  c_1_setInterval = setInterval(function () {
    ...
    $(".c_1").css(
      "background-image",
      'url("./images/Haegeum_motion_' + bomb_roll + '.png")'
    );
  }, 300);
...
function btn_2_on_click() {
  ...
  // 다른 악기 숨기고 장구 확대
  $(".c_2").css({
    animation: "scale_2 1s linear 0s 1 forwards",
    visibility: "",
  });
  $(".instrument").removeClass("active");
  $(".attention_text").css("display", "block");
  ...
  c_2_setInterval = setInterval(function () {
    ...
    $(".c_2").css(
      "background-image",
      'url("./images/janggu_motion_' + bomb_roll + '.png")'
    );
  }, 300);
...
function btn_3_on_click() {
  ...
  // 다른 악기 숨기고 장구 확대
  $(".c_3").css({
    animation: "scale_3 1s linear 0s 1 forwards",
    visibility: "",
  });
  $(".instrument").removeClass("active");
  $(".attention_text").css("display", "block");
  ...
  c_3_setInterval = setInterval(function () {
    ...
    $(".c_3").css(
      "background-image",
      'url("./images/kkwaenggwari_motion_' + bomb_roll + '.png")'
    );
  }, 300);
